...
//        System.out.println(지역변수); //오류O
        System.out.println(전역변수); //오류X
...
//        System.out.println(맴버변수); // 오류o
        Example1 객체 = new Example1();
        System.out.println(객체.맴버변수); // 오류X
    ...
    public static void 임의함수(int 매게변수1){}
